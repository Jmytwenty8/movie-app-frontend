                  ...
                  .filter((row) =>
                    columns.some((column) => {
                      switch (column.id) {
                        ...
                        case "description":
                          return row.movie.description
                            .toString()
                            .toLowerCase()
                            .includes(searchQuery.toLowerCase());
                        case "runtime":
                          return row.movie.runtime
                            .toString()
                            .toLowerCase()
                            .includes(searchQuery.toLowerCase());
                        case "actors":
                          return row.movie.actors.some((actor) =>
                            actor
                              .toString()
                              .toLowerCase()
                              .includes(searchQuery.toLowerCase())
                    ...
                    return (
                      ...
                      >
                        {columns.map((column) => {
                          let value;
                          if (column.id === "movie") {
                            value = row.movie.name;
                          } else if (column.id === "actors") {
                            value = row.movie.actors.join(", ");
                          } else if (column.id === "description") {
                            value = row.movie.description;
                          } else if (column.id === "runtime") {
                            value = row.movie.runtime;
                          }
                          return (
                            <StyledTableCell
                              key={column.id}
